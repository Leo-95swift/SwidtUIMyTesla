...
struct ClmateCustomSLider: View {
    ...
    @Binding var sliderProgressColor: Color
    ...
    init(
        ...
        sliderProgressColor: Binding<Color>
    ) {
        _value = value
        self.minValue = minValue
        self.maxValue = maxValue
        _offset = offset
        _sliderProgressColor = sliderProgressColor
    }
